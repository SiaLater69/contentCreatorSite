        ...
        <form onSubmit={handleSubmit} className="max-w-md mx-auto flex flex-col gap-4">
          <div className="flex gap-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="px-6 py-3 bg-white text-red-600 rounded-lg font-semibold hover:bg-gray-100 transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
            >
